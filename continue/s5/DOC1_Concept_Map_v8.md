...
| Loss convergence behaviour | UNDERSTOOD | Observed fast early drop then slow tail — accepted as normal. Understood why this network doesn't reach zero the way Phase 2 did (25 parameters approximating a line vs 1 weight learning it exactly). | None |
...
_End of Document 1 — Concept Map — v8_
