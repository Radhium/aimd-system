...
**v8 · Experiments, code, and architecture decisions**
...
myLLM/
  ...
  model/                ← model architecture files
    ...
    transformer.py      ← the model itself (not created yet — BUILD next session)
...
| Activation function           | GELU          | Decided Session 10 — standard for GPT-style Transformers |
...
_End of Document 2 — Lab Notebook — v8_
